...
var vexorConnect = function(vexor) {
    ...
    }, // Platform-specific connect methods
    {
        ...
        auth: Object.assign(function(body) {
            return vexor.createConnectAuth(body);
        }, {
            refresh: function(body) {
                return vexor.createConnectAuthRefresh(body);
            }
        }),
        ...
        refund: Object.assign(// Generic refund method
        function(params) {
            return vexor.createConnectRefund(params.platform, params);
        }, // Platform-specific refund methods
        {
            mercadopago: function(body) {
                return vexor.createConnectRefund("mercadopago", body);
            },
            stripe: function(body) {
                return vexor.createConnectRefund("stripe", body);
            }
        })
    });
};
...
function createConnectRefund(vexor, platform, body) {
    return _createConnectRefund.apply(this, arguments);
}
function _createConnectRefund() {
    _createConnectRefund = _async_to_generator(function(vexor, platform, body) {
        var response, data, errorMessage;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                ...
                case 2:
                    ...
                    if (!response.ok) {
                        errorMessage = data.message || "An unknown error occurred";
                        throw new Error("Connect refund request failed: ".concat(errorMessage));
                    }
                    return [
                        2,
                        data
...
function createConnectAuthRefresh(vexor, body) {
    return _createConnectAuthRefresh.apply(this, arguments);
}
function _createConnectAuthRefresh() {
    _createConnectAuthRefresh = _async_to_generator(function(vexor, body) {
        var response, data, errorMessage;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                ...
                case 2:
                    ...
                    if (!response.ok) {
                        errorMessage = data.message || "An unknown error occurred";
                        throw new Error("Connect auth refresh request failed: ".concat(errorMessage));
                    }
                    return [
                        2,
                        data
...
var _Vexor = /*#__PURE__*/ function() {
    function _Vexor(params) {
        ...
        this.custom = function(url) {
            return _this.setApiUrl(url);
        };
    }
    _create_class(_Vexor, [
        ...
        {
            key: "createConnectAuthRefresh",
            value: function createConnectAuthRefresh1(body) {
                return createConnectAuthRefresh(this, body);
            }
        },
        {
            key: "createConnectRefund",
            value: function createConnectRefund1(platform, body) {
    ...
    ], [
        {
            ...
            function fromEnv() {
                ...
                var instance = _Vexor.instance;
                instance.custom = function(url) {
        ...
        },
        {
            ...
            function init(params) {
                var instance = new _Vexor(params);
                instance.custom = function(url) {
                    return this.setApiUrl(url);
                };
                return instance;
